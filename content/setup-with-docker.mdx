...
Database Support: LinkAce supports MariaDB, MySQL, PostgreSQL, and SQLite. The default Docker setup uses MariaDB 12.0.
...
**Note:** The linkace-docker.zip package is automatically generated with each release and contains the necessary docker-compose.yml and .env files pre-configured for production use.
