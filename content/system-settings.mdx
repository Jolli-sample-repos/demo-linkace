...
![Preview of the update check](https://www.linkace.org/media/screen/system_settings_update_check.png)
...
![Preview of th cron token settings](https://www.linkace.org/media/screen/system_settings_cron_token.png)
...
* LinkAce runs the [link check](/docs/v2/application/link-checks/) and sends a notification if moved or dead links were found.
...
![Preview of the general system settings](https://www.linkace.org/media/screen/v2/system_settings_general.png)
...
![Preview of the system guest settings](https://www.linkace.org/media/screen/v2/system_settings_guest_settings.png)

Please check the [user settings documentation](/docs/v2/configuration/user-settings/) for more details about all available options, as they are exactly the same.
...
A complete list of all available settings can be found in the [.env file reference](/docs/v2/configuration/env-settings/).