...
# If you are using self-signed certificates, set this setting to false to not verify SSL connections
...
# Enable backups here
BACKUP_ENABLED=true
# Choose the destination of the backup. If you set up AWS S3 credentials below you may choose 's3' for cloud storage.
...
# If you are using OIDC for Single Sign-On, you can configure JWT verification
