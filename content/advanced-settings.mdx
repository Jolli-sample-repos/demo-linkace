...
{/* Build timestamp: 1766178948488 - Forces cache invalidation */}
...
# Set the mailer used for sending email here, default is `log`
MAIL_MAILER=smtp
...
# Enable backups here (default is true)
BACKUP_ENABLED=true
# Choose the destination of the backup. If you set up AWS S3 credentials below you may choose 's3'.
# Leave blank or set to 'local_backups' if you want to store backups within /storage/app/backups.
...
## If you are using Redis, you may switch SESSION_DRIVER and CACHE_DRIVER to "redis" or "memcached" to improve performance.
SESSION_DRIVER=file
LOG_CHANNEL=stack
...
## Using Redis sockets
# If you want to use Redis via a Unix socket, you can use the following configuration.
# Also, set a proper path to your Redis socket.
