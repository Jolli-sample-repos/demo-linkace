...
BACKUP_ENABLED=true
# Choose the destination of the backup. Default is 'local_backups' which stores backups within /storage/app/backups.
# If you set up AWS S3 credentials below you may choose 's3' to store backups in the cloud.
...
# Maximum size of the backups in megabytes. Default is 265.
BACKUP_MAX_SIZE=265
