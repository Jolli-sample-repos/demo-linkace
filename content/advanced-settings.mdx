...
# Enable backups here. Backups are enabled by default.
BACKUP_ENABLED=true
...
REDIS_PORT=6379
REDIS_DB=0
# Optionally configure a separate database for caching
REDIS_CACHE_DB=1
# Configure the prefix for Redis keys
REDIS_PREFIX=linkace_database_
