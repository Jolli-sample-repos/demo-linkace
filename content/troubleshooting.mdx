...
The absolutely very first step you can try to understand what's wrong is to enable the *Debug Mode*. Error messages might be more detailed then and help find the root cause.
...
If you aren't able to solve the issue with the help of the debug mode or logs, you might search the [community forum](/community/) for your error message. There are tons of threads about all kinds of issues already and yours might already be solved.
