...
All other possible settings can be found in the [.env file reference](https://www.linkace.org/docs/v2/configuration/env-settings/).
...
| `MAIL_MAILER` | `log`, `smtp`, `sendmail`, `mailgun`, `ses`, `postmark` | `log` | The method of sending email, more details see [the Mail configuration docs](https://laravel.com/docs/10.x/mail) |
...
Application backups have a dedicated documentation: [Application backups](https://www.linkace.org/docs/v2/configuration/application-backups/)
