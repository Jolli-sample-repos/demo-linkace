...
Please add the following block to your .env file and change the values according to your email provider's requirements.
...
| MAIL_MAILER | log, smtp, sendmail, mailgun, ses, postmark, array, failover | log | The method of sending email, more details see the Mail configuration docs |
